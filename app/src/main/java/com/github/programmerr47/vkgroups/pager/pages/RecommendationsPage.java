...
public class RecommendationsPage extends Page {
    ...
    public View onCreateView(Context context) {
        return LayoutInflater.from(context).inflate(R.layout.recommendation_layout, null, false);
    }
    ...
    public void onViewCreated(View pageView) {
        ...
        recommendListView = (RecyclerView) pageView.findViewById(R.id.recommendations_list);
