...
package com.github.programmerr47.vkgroups.imageloading;
...
public abstract class ImageWorker {
     ...
     * {@link ImageWorker#processBitmap(Object, LoadBitmapParams)} to define the processing logic). A memory and
     * disk cache will be used. If the
     ...
     */
    public void loadImage(Object data, ImageView imageView, LoadBitmapParams params) {
        if (data == null) {
            return;
        }

        handleParams(imageView, params);
     ...
     *            {@link ImageWorker#loadImage(Object, android.widget.ImageView, LoadBitmapParams)}
     * @return The processed bitmap
     */
    protected abstract Bitmap processBitmap(Object data, LoadBitmapParams params);
    ...
    private class BitmapWorkerTask extends AsyncTask<LoadBitmapParams, Void, Pair<BitmapDrawable, LoadBitmapParams>> {
        ...
        protected Pair<BitmapDrawable, LoadBitmapParams> doInBackground(LoadBitmapParams... params) {
            ...
            LoadBitmapParams loadBitmapParams = params[0];
            ...
            if (bitmap == null && !isCancelled() && getAttachedImageView() != null
                    && !mExitTasksEarly) {
                bitmap = processBitmap(mData, loadBitmapParams);
            }
